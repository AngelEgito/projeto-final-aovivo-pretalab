...
O site já está no ar e você pode acessar aqui: [Meu site pessoal](https://projeto-final-aovivo-pretalab.vercel.app/)
...
_Foi incrível nossa essa jornada no desenvolvimento e aprendizado! Qualquer dúvida, chama no contatinho!_

### Prazer, Angélica Egito!

 <img src="https://avatars.githubusercontent.com/u/82975477?v=4" alt="Gif Yeah" width="200"> 

✓	Desenvolvedora em formação.

✓	Estudante de tecnologia na área de front-end.

✓	Determinada, esforçãda e dedicada em cada ação proposta.

### Vamos nos conectar?

- [instagram](https://www.instagram.com/angelicaegito/)
- [linkedin](www.linkedin.com/in/angelica-egito)
- [github](https://github.com/AngelEgito)
